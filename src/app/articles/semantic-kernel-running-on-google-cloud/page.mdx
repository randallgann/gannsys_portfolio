...
[Frontend NextJs App](https://github.com/randallgann/sk-webapp)
[Backend .NET Semantic Kernel WebAPI](https://github.com/randallgann/SK-Chat-WebAPI-MikeyAndMe.git)
