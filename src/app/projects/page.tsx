...
export const metadata: Metadata = {
  title: 'Projects',
  description: 'Software things I’ve made.',
}

export default function Projects() {
  return (
    <SimpleLayout
      title="Software things I’ve made."
      intro="I've worked on plenty of side projects over the past few years of being in software development.  Most have been complete trash, but a few have turned out well enough that I don't mind sharing them.  They are fairly simple apps I've built to increase my knowledge and expertise."
    >
      <ul
        role="list"
